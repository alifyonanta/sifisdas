...
public class ASPRAK extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(TPASSWORD, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 320, 110, 30));
        ...
        getContentPane().add(TNOHP, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 280, 110, 30));
        ...
        getContentPane().add(LALAMAT, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, -1, -1));

        LAGAMA.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        LAGAMA.setText("Password");
    ...
    private void BHAPUSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHAPUSActionPerformed
        try {
            pernyataan.executeUpdate("delete from asprak where kode_asprak='"+TNIM.getText()+"'");
            bersihkan();
            tampildata();
    ...
    private void BSIMPANActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSIMPANActionPerformed
        try{
            pernyataan.executeUpdate("insert into asprak set  kode_asprak='"+TNIM.getText()+"',"+
                "nama_asprak='"      +TNAMA.getText()+"',"+
    ...
    private void BPERBAHARUIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BPERBAHARUIActionPerformed
        try{
            pernyataan.executeUpdate("update asprak set  kode_asprak='"                +TNIM.getText()+
                "',nama_asprak='"      +TNAMA.getText()+
                "',jenis_kelamin='"   +CJENISKELAMIN.getSelectedItem()+
               
                "',password='"         +TPASSWORD.getText()+
                "',no_hp='"         +TNOHP.getText()+
                "' where kode_asprak='"       +TNIM.getText()+"'");
    ...
    private void TNIMKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TNIMKeyPressed
        try {
            ...
            pengaturanhasil = pernyataan.executeQuery("select * from asprak where kode_asprak='"+TNIM.getText()+"'");

            while (pengaturanhasil.next()){              
                TNAMA.setText(pengaturanhasil.getString("nama_asprak"));
                CJENISKELAMIN.setSelectedItem(pengaturanhasil.getString("Jenis_Kelamin"));
                
                TPASSWORD.setText(pengaturanhasil.getString("password"));
